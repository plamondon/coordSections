...
We will deduce this result from the known case of triangulations and a general algebraic observation on support $\tau$-tilting modules and their $\b{g}$-vectors (see Section~\ref{sec:recollections} for definitions).
...
Such a map is easy to guess using $\b{g}$-vectors, but the proof that it is actually a bijection and that it preserves compatibility is intricate.
