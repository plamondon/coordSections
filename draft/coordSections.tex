...
\begin{abstract}
We show that any accordion complex associated to a dissection of a polygon is isomorphic to the support $\tau$-tilting simplicial complex of an explicit finite dimensional algebra.
To this end, we prove a property of certain induced subcomplexes of support $\tau$-tilting simplicial complexes of finite dimensional algebras.
\end{abstract}
...
In this case, it is known~\cite{??} that the $\dissection_\circ$-accordion complex is isomorphic to the $2$-term silting object of the quiver~$\overline{\quiver}(\dissection_\circ)$ of the triangulation~$\dissection_\circ$.
...
For any reference dissection~$\dissection_\circ$, the $\dissection_\circ$-accordion complex is isomorphic to the $2$-term silting object of the quiver~$\overline{\quiver}(\dissection_\circ)$.
\end{theorem}
