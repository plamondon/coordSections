...
\address[Pierre-Guy Plamondon]{Laboratoire de Math\'ematiques d'Orsay, \newline\indent Universit\'e Paris-Sud, CNRS, Universit\'e Paris-Saclay}
%\urladdr{\url{https://www.math.u-psud.fr/~plamondon/}}

\author{Salvatore Stella}
\email{stella@mat.uniroma1.it}
\address[Salvatore Stella]{Department of Mathematics \& Department of Computer Science, \newline\indent University of Haifa, Haifa, Mount Carmel 31905, Israel}
%\urladdr{\url{http://www1.mat.uniroma1.it/people/stella/}}

\classification{16G10, 16G20, 05E10}
\keywords{accordion complexes, $\tau$-tilting theory, finite dimensional algebras}
