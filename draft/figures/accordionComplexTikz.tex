...
\newcommand{\associahedronAccordionTikz}{
	...
	\useasboundingbox (-1,-1) rectangle(8*\hgap+1, 4*\vgap+1);
    	...
    	\node (t2)  at (  1*\hgap,   3*\vgap) {\dissectionTikz{6}{1/3, 3/5, 3/6}};
    	\node (t3)  at (  4*\hgap,   3*\vgap) {\dissectionTikz{6}{1/5, 2/5, 3/5}};
    	\node (t4)  at (  7*\hgap,   3*\vgap) {\dissectionTikz{6}{1/3, 1/4, 1/5}};
    	\node (t5)  at (  0*\hgap, 2.2*\vgap) {\dissectionTikz{6}{1/3, 3/6, 4/6}};
    	\node (t6)  at (  8*\hgap, 2.2*\vgap) {\dissectionTikz{6}{1/3, 1/4, 4/6}};
    	\node (t7)  at (1.8*\hgap, 1.8*\vgap) {\dissectionTikz{6}{2/6, 3/6, 3/5}};
    	\node (t8)  at (3.2*\hgap, 1.8*\vgap) {\dissectionTikz{6}{2/6, 2/5, 3/5}};
    	\node (t9)  at (4.8*\hgap, 1.8*\vgap) {\dissectionTikz{6}{1/5, 2/5, 2/4}};
    	\node (t10) at (6.2*\hgap, 1.8*\vgap) {\dissectionTikz{6}{1/5, 1/4, 2/4}};
    	\node (t11) at (  1*\hgap,   1*\vgap) {\dissectionTikz{6}{2/6, 3/6, 4/6}};
    	\node (t12) at (  4*\hgap,   1*\vgap) {\dissectionTikz{6}{2/6, 2/5, 2/4}};
...
\newcommand{\associahedronSiltingTikz}{
	\begin{tikzpicture}[scale=.6, vert/.style={inner sep=1pt, draw}]
	\useasboundingbox (-1,-1) rectangle(8*\hgap+1, 4*\vgap+1);
		% vertices = triangulations
